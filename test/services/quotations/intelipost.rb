module IntelipostQuotationsTest
  ...
  def stub_intelipost_requests
    stub_request(:post, "https://api.intelipost.com.br/api/v1/quote_by_product").
      with(:body => "{\"origin_zip_code\":\"03320-000\",\"destination_zip_code\":\"80035-120\",\"additional_information\":{\"sales_channel\":\"Loja\"},\"products\":[{\"sku\":null,\"cost_of_goods\":null,\"height\":2.0,\"length\":14.0,\"width\":7.0,\"weight\":null,\"description\":\"\",\"quantity\":1}]}",
